...
I recently worked on a [rust wrapper](https://github.com/zhenfeizhang/falcon-rust) of the reference implementation for Falcon signature scheme. Also [a rank-1 constraint system (R1CS) implementation
